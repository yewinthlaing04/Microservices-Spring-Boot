package com.ye.loan.controller;


import com.ye.loan.constants.LoansConstants;
import com.ye.loan.dto.ErrorResponseDto;
import com.ye.loan.dto.LoansContactInfoDto;
import com.ye.loan.dto.LoansDto;
import com.ye.loan.dto.ResponseDto;
...
@Tag(
        name = "CRUD REST APIs for Loans in NeoBank",
        description = "CRUD REST APIs in NeoBank to CREATE, UPDATE, FETCH AND DELETE loan details"
)
@RestController
